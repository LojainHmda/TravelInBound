"""
Migrate supplier payments to use prepayment lines
"""
from app import db
from app.models import SupplierPayment, SupplierPrepaymentLine
import logging

# Configure logging
logging.basicConfig(level=logging.INFO)

def create_prepayment_lines():
    """Create prepayment lines for existing supplier payments"""
