...
class InboundTransport(db.Model):
    ...
    def pickup_point(self):
        """Alias for pickup_location to match template expectations"""
        return self.pickup_location

    @property
    def drop_off_point(self):
        """Alias for dropoff_location to match template expectations"""
        return self.dropoff_location

    @property
    def service_date(self):
        """Alias for date to match template expectations"""
        return self.date
...
class InboundGuide(db.Model):
    ...
    @property
    def telephone(self):
        """Alias for telephone_number to match template expectations"""
